...
$sql = "SELECT * FROM `tb_pesan` WHERE 1";
...
<body>
  <div class="container">
    ...
    <div id="adminArea" style="display:none">
      ...
      <div class="info">Auto-refresh setiap 1 detik ⏱️</div>
      <div id="messages"></div>
    </div>
  </div>
    ...
    function showPopup(msg){
      ...
      popup.innerHTML=`
        <div class="popup-card">
          ...
          <button class="screenshot-btn">📸 Siap Screenshot</button>
        </div>`;
      ...
      ssBtn.onclick=()=>{
        ...
        setTimeout(()=>alert('Mode screenshot aktif — ambil tangkapan layar sekarang!'),100);
      };
